...
class ProviderMigrator:
    ...
    PROVIDER_PATHS = {
        ...
        "codeium": {
            "user_config": ["~/.codeium/config.json", "~/.codeium/windsurf/config.json"],
            "user_mcp": ["~/.codeium/mcp_config.json", "~/.codeium/windsurf/mcp_config.json"],
            "user_skills": ["~/.codeium/skills/", "~/.codeium/windsurf/skills/"],
            "user_rules": ["~/.codeium/AGENTS.md", "~/.codeium/windsurf/AGENTS.md"],
            "project_config": [".codeium/config.json"],
            "project_mcp": [".codeium/mcp_config.json"],
            "project_local": [".codeium/config.local.json"],
            "project_local_mcp": [".codeium/mcp_config.local.json"],
            "project_skills": [".codeium/skills/"],
            "project_rules": [".codeium/AGENTS.md"],
        },
        "windsurf": {
